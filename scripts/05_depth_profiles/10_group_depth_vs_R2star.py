...
FIG_DATA = [
    "/home/faruk/data2/DATA_MRI_NIFTI/derived/plots/23_depth_vs_R2star/sub-01_depth_vs_R2star.npy",
    "/home/faruk/data2/DATA_MRI_NIFTI/derived/plots/23_depth_vs_R2star/sub-02_depth_vs_R2star.npy",
    "/home/faruk/data2/DATA_MRI_NIFTI/derived/plots/23_depth_vs_R2star/sub-03_depth_vs_R2star.npy",
    "/home/faruk/data2/DATA_MRI_NIFTI/derived/plots/23_depth_vs_R2star/sub-04_depth_vs_R2star.npy",
    "/home/faruk/data2/DATA_MRI_NIFTI/derived/plots/23_depth_vs_R2star/sub-05_depth_vs_R2star.npy",
    ]

TAGS = ["Heschl's Gyrus Right", "Heschl's Gyrus Left",
        "Calcarine Sulcus Right", "Calcarine Sulcus Left"]

OUTDIR = "/home/faruk/data2/DATA_MRI_NIFTI/derived/plots/23_depth_vs_R2star"
SUBJ_ID = "group"
FIGURE_TAG = "depth_vs_R2star"
...
for i in range(4):
    ...
    ax[i].text(-0.7 + 0.025, 50, 'Below\ngray matter\n(White matter)',
               fontsize=10, color="white")
    ax[i].text(0 + 0.025, 50, 'Gray matter\n\n',
               fontsize=10, color="white")
    ax[i].text(1 + 0.025, 50, 'Above\ngray matter\n(CSF & vessels)',
               fontsize=10, color="white")
