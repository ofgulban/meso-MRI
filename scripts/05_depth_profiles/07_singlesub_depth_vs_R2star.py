...
for s in SUBJ_ID:
    ...
    METRIC_Y = "/home/faruk/data2/DATA_MRI_NIFTI/derived/{}/T2s/12_T2star/{}_ses-T2s_part-mag_MEGRE_crop_ups2X_prepped_avg_composite_decayfixed_R2s.nii.gz".format(s, s)
    ...
    VMIN, VMAX = 0, 175  # Histogram bin count min and max
    CMAP = cc.cm.fire
    ...
    for i in range(len(CHUNKS)):
        ...
        metric_y = np.asarray(nii_y.dataobj)[idx] * 1000  # !!! ms to s !!!
