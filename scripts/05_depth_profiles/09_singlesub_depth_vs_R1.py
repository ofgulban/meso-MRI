...
for s in SUBJ_ID:
    ...
    METRIC_Y = "/home/faruk/data2/DATA_MRI_NIFTI/derived/{}/T1/07_register_to_T2s/{}_ses-T1_MP2RAGE_T1_crop_ups2X_avg_reg_R1_inOneDivSec.nii.gz".format(s, s)
    ...
    VMIN, VMAX = 0, 550  # Histogram bin count min and max
    CMAP = cmocean.cm.ice
    ...
    for i in range(len(CHUNKS)):
        ...
        ax[i].text(0+1, median_line_x + 1, '{:.3f}'.format(median_x),
                   fontsize=10, color="white")
        ...
        ax[i].plot((50, 150), (median_line_x, median_line_x),
                   '-', linewidth=1.5, color="white")
        ax[i].text(50+1, median_line_x + 1, '{:.3f}'.format(median_x),
                   fontsize=10, color="white")
        ...
        ax[i].plot((150, 200), (median_line_x, median_line_x),
                   '-', linewidth=1.5, color="white")
        ax[i].text(150+1, median_line_x + 1, '{:.3f}'.format(median_x),
                   fontsize=10, color="white")
